                ...
                if visitedPreviously(openList[0]) == False:
                    ...
                    if evaluate(openList[0].matrix) == "WON":
                       ...
                       #add to closed list
                        ...
                        currentNode
                        #print "Added to Closed list", closedList[len(closedList)-1], closedList[len(closedList)-1].depth, closedList[len(closedList)-1].width
                        ...
                        #print "Removed from open list", currentNode, currentNode.depth, currentNode.width
                        #for elem in openList:
                            #print elem.depth, elem.width, elem
                            #print "jake1"
